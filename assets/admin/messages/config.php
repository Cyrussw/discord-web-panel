                ...
                <div class="main">
                    ...
                    <main class="content px-3 py-2">
                        <div class="container-fluid">
                            <div class="mb-3">
                                <?php
                                $message_sql = "SELECT * FROM readymessage";
                                $message_result = $db->query($message_sql);
                                ...
                                if ($message_result->num_rows > 0) {
                                    ...
                                    while ($row = $message_result->fetch_assoc()) {
                                        ...
                                        echo "<td><a href='./editMessage.php?id=" . $row["id"] . "'>Düzenle</a></td>";
                                        echo "</tr>";
                                    }
                                    echo "</table>";
                                } else {
                                    echo "Henüz mesaj bulunmuyor.";
                                }
                                ?>
                            </div>
                        </div>
